...
public class AntMerchantExpandContractFacetofaceSignModel extends AlipayObject {
    ...
    public void setBusinessLicenseAuthPic(
            String businessLicenseAuthPic) {
    ...
    public void setBusinessLicenseNo(
    ...
    public void setBusinessLicensePic(
    ...
    public void setShopSignBoardPic(
            String shopSignBoardPic) {
    ...
    public void setSpecialLicensePic(
            String specialLicensePic) {
