 ...
 *
 * @author yikai.hu
 * @version $Id: AlipayMobilePublicMultiMediaClient.java, v 0.1 Aug 15, 2014
 *          10:19:01 AM yikai.hu Exp $
 */
public class AlipayMobilePublicMultiMediaClient implements AlipayClient {
    ...
    public <T extends AlipayResponse> T doGet(
            AlipayRequest<T> request,
            String appAuthToken) throws AlipayApiException {
        ...
        } else if (AlipayConstants.SIGN_TYPE_RSA2.equals(sign_type)) {

            String signContent = AlipaySignature.getSignatureContent(requestHolder);

            protocalMustParams.put(AlipayConstants.SIGN, AlipaySignature.rsa256Sign(signContent, privateKey, charset));
        ...
        try {
            ...
            if (request instanceof AlipayMobilePublicMultiMediaDownloadRequest) {
                ...
                rsp = doGet(serverUrl, requestHolder, charset, connectTimeout, readTimeout, outputStream);
            }
        } catch (IOException e) {
    ...
    public static AlipayMobilePublicMultiMediaDownloadResponse doGet(
            ...
            int connectTimeout,
            int readTimeout,
            OutputStream output) throws AlipayApiException, IOException {
