...
public class AlipayFundTransBatchCreatesinglebatchModel extends AlipayObject {
    ...
    /**
     * 扩展参数,目前淘系会传商品类目过来key=categoryNo。注：长度不可超过100; 数据格式需要为json串
     */
    @ApiField("ext_param")
    ...
    public void setPayAmountSingle(
            String payAmountSingle) {
    ...
    public void setPayAmountTotal(
            String payAmountTotal) {
    ...
    public void setRealItemsTotal(
            String realItemsTotal) {
    ...
    public void setShowItemsTotal(
            String showItemsTotal) {
