...
public class AlipayOfflineMarketShopModifyModel extends AlipayObject {
    ...
    /**
     * 许可证，各行业所需的证照资质参见<a href=
     * "https://doc.open.alipay.com/doc2/detail.htm?treeId=205&amp;articleId=104497&amp;docType=1">商户入驻要求</a>；该字段只能上传一张许可证，一张以外的许可证、除营业执照和许可证之外其他证照请放在其他资质字段上传。
     */
    ...
    /**
     * 请严格按"周一-周五 09:00-20:00,周六-周日
     * 10:00-22:00"的格式进行填写，时间段不能重复，最多支持两个时间段，24小时营业请填写"00:00-23:59"
     */
    @ApiField("business_time")
    private String businessTime;

    /**
     * 废弃字段，不支持修改类目。 类目id，请参考<a href=
     * "https://doc.open.alipay.com/doc2/detail.htm?treeId=205&amp;articleId=104497&amp;docType=1">商户入驻要求</a>。
     */
    @ApiField("category_id")
    private String categoryId;

    /**
     * 城市编码，国标码，详见国家统计局数据 <a href=
     * "http://aopsdkdownload.cn-hangzhou.alipay-pub.aliyun-inc.com/doc/2016.xls">点此下载</a>。
     */
    @ApiField("city_code")
    ...
    /**
     * 主门店名
     * 比如：肯德基；主店名里不要包含分店名，如“万塘路店”。主店名长度不能超过20个字符。【xxx店】、(xxx店)、（xxx店）、[xxx店]、&lt;xxx店&gt;、xxx店，等类似的主店名都是不合法的，如果需要录入分店，请填写到branch_shop_name字段中。
     */
    ...
    /**
     * 外部请求ID;
     * 标识ISV本次修改的请求，由开发者自定义，不同的请求使用不同的ID，在门店notify消息中也会带有该参数，以此标明本次notify消息是对哪个请求的回应
     */
    @ApiField("request_id")
    ...
    public void setBusinessCertificate(
    ...
    public void setBusinessCertificateExpires(
            String businessCertificateExpires) {
    ...
    public void setIsOperatingOnline(
            String isOperatingOnline) {
    ...
    public void setLicenceExpires(
            String licenceExpires) {
    ...
    public void setOperateNotifyUrl(
    ...
    public void setOtherAuthorization(
            String otherAuthorization) {
