...
public class AlipayCommerceMedicalInstcardCreateandpayModel extends AlipayObject {
    ...
    public void setMedicalCardInstId(
    ...
    public void setPatientCardType(
            String patientCardType) {
